...
REFDIR=$WKDIR/GRCm38_ref/GRCm38_68  #needs to contain unzipped ref .fa
CASTDIR=$WKDIR/Cast_EiJ/CastEiJ_GRCm38  ##put both .bash script and vcf.gz into CASTDIR
VCF_FILE=$CASTDIR/mgp.v5.merged.snps_all.dbSNP142.vcf.gz 
...
SNPsplit_genome_preparation --full_sequence -genome_build GRCm38 --vcf_file $VCF_FILE --reference_genome $REFDIR --strain CAST_EiJ
